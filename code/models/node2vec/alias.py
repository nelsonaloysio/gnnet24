...
def alias_setup_edges(
    ...
    :param G: Graph to generate embeddings.
    :param p: Higher values promote BFS walks. Default: 1.0.
    :param q: Lower values promote DFS walks. Default: 1.0.
    :param c: Lower values promote cycles. Default: 1.0.
    :param r: Lower values promote graph exploration.
        Used in alternative to `p`, `q`, `c`. Default: 1.0.
    :param t: Lower values promote temporal exploration.
        Only used for undirected temporal graphs. Default: 0.0.
    :param edge_weight: Dictionary with edge weights.
    :param edge_time: Dictionary with edge times.
    :param edge_keys: Dictionary with edge keys.
    :param reverse: If True, the random walks are computed
        in the reverse direction. Useful for undirected graphs.
    :param norm_exp: If True, the transition probabilities are
